...
from . import contracts, world_records, memory_records, metabolism_records, assessment_records, socion_records, composition_records, language_records, organization_records, crux


def _classes(base):
    return {c.__name__: c for module in (contracts, world_records, memory_records, metabolism_records, assessment_records, socion_records, composition_records, language_records, organization_records, crux)
